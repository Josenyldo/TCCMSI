...
void QVGA_Image(){
  ...
  while (!(PIND & 8));//wait for high pino D3 do arduino que contem o pino VSyNc da camera
  while ((PIND & 8));//wait for low guarda o pino VSYnc ir para baixo.
 int cont = 0;
    h = 13;
    byte dataBuffer[100][50];
  while (h--){
        w = 100;
    ...
    while (w--){
      ...
      /*
        Quando faço PINC & 15, leio os valores dos pinos analigos .
        que vao de A0-A3, pois 15 reprensenta 00001111, onde cada bit representa um pino da entrada analogica do arduino.
        Quando faço PIND & 240 leio os valores dos pinos D7-D4 do arduino, pois 240 representa 11110000 onde cada bit representa um pino de entrada digital do arduino.
      ...
      */
         dataBuffer [49-h][99 -w]= (PINC & 15) | (PIND & 240); 
